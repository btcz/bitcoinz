...
BITCOIND=${BITCOIND:-$BINDIR/bitcoinzd}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/bitcoinz.conf}
...
echo 'Generating example bitcoinz.conf file in share/examples/'
...
##
## bitcoinz.conf configuration file.
## Generated by contrib/devtools/gen-bitcoinz-conf.sh.
##
...
# parse the output from bitcoinzd --help
