...
This directory contains the files necessary to perform bootstrappable BitcoinZ
Core builds.
...
To build BitcoinZ reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/bitcoinz-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/btcz/guix.sigs).
