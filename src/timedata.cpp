...
void CTimeWarning::Warn(size_t peersAhead, size_t peersBehind)
{
    ...
    if (peersBehind >= TIMEDATA_WARNING_MAJORITY) {
        strMessage = _("Your computer's date and time may be ahead of the rest of the network! If your clock is wrong BitcoinZ will not work properly.");
    } else if (peersAhead >= TIMEDATA_WARNING_MAJORITY) {
        strMessage = _("Your computer's date and time may be behind the rest of the network! If your clock is wrong BitcoinZ will not work properly.");
    } else {
        strMessage = _("Please check that your computer's date and time are correct! If your clock is wrong BitcoinZ will not work properly.");
    }
