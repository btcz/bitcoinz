...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # send 1.2 BTCZ to multisig address
        ...
        # make sure funds are received at node1
        assert_equal(oldBalance+Decimal('12501.1'), self.nodes[0].getbalance())
        ...
        self.nodes[0].generate(1)
        self.sync_all()
        assert_equal(oldBalance+Decimal('12500.19'), self.nodes[0].getbalance()) #0.19+block reward
