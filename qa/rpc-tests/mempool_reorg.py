...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        spend_101_raw = self.create_tx(coinbase_txids[1], node1_address, 12500)
        spend_102_raw = self.create_tx(coinbase_txids[2], node0_address, 12500)
        spend_103_raw = self.create_tx(coinbase_txids[3], node0_address, 12500)
