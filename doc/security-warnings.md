...
are physically near the hardware, that your `bitcoinzd` process is running on will
be able to:
...
unprivileged) on the hardware your `bitcoinzd` process runs on until these
